        ...
        >
            <div className='welcome__info relative'>
                <div className='welcome__info__content'>
                    ...
                    <div className='description m-t-4'>
                        ...
                        All the high-skill competition you crave, designed especially for mobile 
                        and console with revamped controls and streamlined matches.Explore the 
                        living universe of Runeterra through lore, comics, games, and more. Then 
                        dive into the community of gamers, cosplayers, musicians, and content 
            ...
            <div className='welcome__info relative'>
                <div className='welcome__img__slide' id='welcome__img__slide'>
                    {
                        champImgs.map((item, index) => (<img src={item} key={index} />))
                    }
                </div>
            </div>
        </HomeSection>
